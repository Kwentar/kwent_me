...
import { Layers, Plus, Trash2, Map, Upload, Eye, EyeOff, Users, Shield, Lock, Unlock, User as UserIcon } from 'lucide-react';
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-sm font-medium text-slate-200 flex items-center gap-1">
                                    {u.name}
                                    {u.id === currentUser.id && <span className="text-[10px] text-slate-500">(You)</span>}
                                </div>
